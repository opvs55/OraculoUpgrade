...
function Loader({ customText }) {
  ...
  }, [customText]); // O array vazio [] garante que este efeito só rode uma vez, quando o componente aparece

  const displayText = customText || frasesDeLoading[indiceFrase];
  const key = customText || indiceFrase;
  ...
  return (
    <div className={styles.loaderContainer}>
      ...
      <p key={key} className={styles.loadingText}>
        {displayText}
      </p>
    </div>
  );
